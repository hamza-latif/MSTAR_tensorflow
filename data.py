...
class DataHandler:
    ...
    def __init__(self, batch_location, number_batches, mini_batch_size, one_hot=True):
        ...
        self.train_size = self.meta[
            'num_cases_per_batch'] * self.number_batches

        self.num_mini_batches = self.meta[
    ...
    def get_next_mini_batch(self):
        ...
        self.current_mini_batch = (
            self.current_mini_batch + 1) % self.num_mini_batches
...
def test(batch_location, number_batches, mini_batch_size, one_hot=True):
    tester = DataHandler(batch_location, number_batches,
                         mini_batch_size, one_hot)
